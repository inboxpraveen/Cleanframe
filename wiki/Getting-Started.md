...
- [Concepts](Concepts) — recipes, quarantine, drift
- [Production guide](Production-Guide) — large files, CI, safety
- [Recipe specification](Recipe-Specification) — edit recipes by hand
- [LLM planning](LLM-Planning) — optional AI-assisted planning
